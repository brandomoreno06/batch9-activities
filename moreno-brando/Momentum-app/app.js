...
inputName.oninput = function () {
    if (inputName.checkValidity() || inputName.value.trim() !== "") {
...
//Opening and closing quotes modal
...
//Displaying quotes (method to display input quote)
...
function removeQuoteItem() {
    var removeQuoteButton = document.querySelector(".remove")
